...
export const Chart = ({ width, height, color }) => (
  <Svg width={width} height={height} viewBox="0 0 24 24">
    <Path
...
export const Group = ({ width, height, color }) => (
  <Svg width={width} height={height} viewBox="0 0 24 24">
    <Path
...
export const Donation = ({ width, height, color }) => (
  <Svg width={width} height={height} viewBox="0 0 24 24">
    <Path
...
export const Profile = ({ width, height, color }) => (
  <Svg width={width} height={height} viewBox="0 0 24 24">
    <Path
